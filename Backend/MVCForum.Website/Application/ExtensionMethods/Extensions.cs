...
namespace MVCForum.Website.Application
{
   ...
   //</nav>
        ...
        public static MvcHtmlString Pager(this HtmlHelper helper, int currentPage, int pageSize, int totalItemCount, object routeValues, string actionOveride = null, string controllerOveride = null)
        {
            ...
            container.AddCssClass("pagination pagination__custom float-right mt-4");
            ...
            if (currentPage > 1)
            {
                ...
                previousli.AddCssClass("page-item page-item__custom-number");
            ...
            if (currentPage > cGroupSize)
            {
                ...
                previousDotsli.AddCssClass("page-item page-item__custom-number");
                var previousDots = new TagBuilder("a");
                previousDots.SetInnerText("...");
                previousDots.AddCssClass("page-link");
            ...
            for (var i = groupStart; i <= groupEnd; i++)
            {
                ...
                pageNumberli.AddCssClass(((i == currentPage)) ? "page-item page-item__custom-arrow" : "page-item page-item__custom-number");
                var pageNumber = new TagBuilder("a");
                pageNumber.AddCssClass("page-link");
            ...
            if (pageCount > groupEnd)
            {
                ...
                nextDotsli.AddCssClass("page-item page-item__custom-number");
                var nextDots = new TagBuilder("a");
                nextDots.SetInnerText("...");
                nextDots.AddCssClass("page-link");
            ...
            if (currentPage < pageCount)
            {
                ...
                nextli.AddCssClass("page-item page-item__custom-number");
