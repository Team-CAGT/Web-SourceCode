...
namespace MVCForum.Website.Controllers
{
    public partial class MembersController : BaseController
    {
        ...
        public ActionResult MemberRegisterLogic(MemberAddViewModel userModel)
        {
            ...
            return RedirectToAction("Manage", "account", new { area = "admin" });
        }
                        ...
                        if (!e.Cancel)
                        {
                            ...
                            if (MembershipService.ValidateUser(username, password, System.Web.Security.Membership.MaxInvalidPasswordAttempts))
                            {
                                ...
                                if (user.IsApproved && !user.IsLockedOut && !user.IsBanned)
                                {
                                    ...
                                    var url = Url.Action("Index", "Admin", new {area = "Admin"});
                                    return Json(new
                                    {
                                        Result = true,
                                        Message = "Thành công"
                                ...
                                //   return RedirectToAction("Index", "Admin", new { area = "Admin" });
                                    //if (User.IsInRole("Admin") || User.IsInRole("VietBai") || User.IsInRole("TuyenDung") || User.IsInRole("HoiDap"))
                                    //{
                                    //    return RedirectToAction("Index", "Admin", new {area = "Admin"});
                                    //}
                                    //else
                            ...
                            else
                            {
                                ...
                                switch (loginStatus)
                                {
                                    ...
                                    case LoginAttemptStatus.PasswordIncorrect:
                                        ...
                                        loggingErrorMessage = LocalizationService.GetResourceString("Members.Errors.PasswordIncorrect");
                                        break;
                                    ...
                                    case LoginAttemptStatus.PasswordAttemptsExceeded:
                                        ...
                                        loggingErrorMessage = LocalizationService.GetResourceString("Members.Errors.PasswordAttemptsExceeded");
                                        break;
                                    ...
                                    case LoginAttemptStatus.UserLockedOut:
                                        ...
                                        loggingErrorMessage = LocalizationService.GetResourceString("Members.Errors.UserLockedOut");
                                        break;
                                    ...
                                    case LoginAttemptStatus.Banned:
                                        ...
                                        loggingErrorMessage = LocalizationService.GetResourceString("Members.NowBanned");
                                        break;
                                    ...
                                    case LoginAttemptStatus.UserNotApproved:
                                        ...
                                        user = MembershipService.GetUser(username);
                                        SendEmailConfirmationEmail(user);
                                        loggingErrorMessage = LocalizationService.GetResourceString("Members.Errors.UserNotApproved");
                                        break;

                                    default:
                                        ModelState.AddModelError(string.Empty, LocalizationService.GetResourceString("Members.Errors.LogonGeneric"));
                                        loggingErrorMessage = LocalizationService.GetResourceString("Members.Errors.LogonGeneric");
                                        break;
        ...
        public ActionResult LogOff()
        {
            using (UnitOfWorkManager.NewUnitOfWork())
            {
                ...
                return RedirectToAction("Trangchu", "Home", new { area = string.Empty });
            }
        }
