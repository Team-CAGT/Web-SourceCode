...
namespace MVCForum.Website.ViewModels
{
    ...
    public class CreateEditTopicViewModel
    {
        ...
        [StringLength(1000)]
        [ForumMvcResourceDisplayName("Description")]
        public string Description { get; set; }
        [StringLength(180)]
        [ForumMvcResourceDisplayName("Topic.Label.MetaSeo")]
        ...
        [Url]
        // [Required]
        [ForumMvcResourceDisplayName("Topic.Label.LinkImage")]
        public string LinkImage { get; set; }

        [ForumMvcResourceDisplayName("Topic.Label.TypeTopic")]
