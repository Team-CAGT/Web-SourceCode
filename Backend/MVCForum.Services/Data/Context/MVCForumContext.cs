...
using MVCForum.Services.Data.Mapping;
...
namespace MVCForum.Services.Data.Context
{
    public partial class MVCForumContext : DbContext, IMVCForumContext
    {
        ...
        public DbSet<SoyteInfo> SoyteInfo { get; set; }
        public DbSet<BangiaDichvu> BangiaDichvu { get; set; }
        public DbSet<Department> Department { get; set; }
        public DbSet<Recruitment> Recruitment { get; set; }
        public DbSet<ApplyCV> ApplyCV { get; set; }
        public DbSet<MedicalPackage> MedicalPackage { get; set; }
