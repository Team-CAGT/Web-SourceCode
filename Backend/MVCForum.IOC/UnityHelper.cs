...
namespace MVCForum.IOC
{
    ...
    public static partial class UnityHelper
    {
        ...
        {           
            ...
            container.BindInRequestScope<IDoctorService, DoctorService>();
            container.BindInRequestScope<IBannerService, BannerService>();
            container.BindInRequestScope<IImageService, ImageService>();
            container.BindInRequestScope<IHospitalFeeService, HospitalFeeService>();
            container.BindInRequestScope<IRecruitmentService, RecruitmentService>();
            container.BindInRequestScope<IMedicalPackageService, MedicalPackageService>();
            container.BindInRequestScope<IEducationService, EducationService>();
